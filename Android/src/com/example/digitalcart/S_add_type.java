...
public class S_add_type extends Activity {
	EditText e1;
	Button b1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_s_add_type);
		try
    	{
		...
		b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				{
				SoapObject obj=new SoapObject(soapclass.NAMESPACE, "addtype");
				obj.addProperty("producttype", e1.getText().toString());
				soapclass sc=new soapclass();
				String ou=sc.Callsoap(obj,  "http://tempuri.org/addtype");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.s_add_type, menu);
		return true;
	}
